...
class TaskExecutor:
    ...
    def _run_task(self, task_id: str):
        ...
        try:
            ...
            self._log(task_id, "✅ 任务执行成功")
            
        except Exception as e:
            task["status"] = "failed"
            task["error"] = str(e)
            self._log(task_id, f"❌ 执行失败: {e}")
    ...
    def _simulate_workflow_execution(self, task_id: str, workflow: str, description: str) -> Dict[str, Any]:
        """模拟工作流执行（用于演示阶段保障体验）"""
