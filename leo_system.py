...
# 加载registry模块
registry = load_module_from_file("leo_orchestrator.registry", str(current_path / "leo_orchestrator" / "registry.py"))
api = load_module_from_file("leo_orchestrator.api", str(current_path / "leo_orchestrator" / "api.py"))
...
# 加载subagents模块
base_agent = load_module_from_file("leo_subagents.agents.base_agent", str(current_path / "leo_subagents" / "agents" / "base_agent.py"))
AgentFactory = base_agent.AgentFactory
AgentConfig = base_agent.AgentConfig

skill_adapter = load_module_from_file("leo_subagents.skills_bridge.skill_adapter", str(current_path / "leo_subagents" / "skills_bridge" / "skill_adapter.py"))
skill_loader = load_module_from_file("leo_subagents.skills_bridge.skill_loader", str(current_path / "leo_subagents" / "skills_bridge" / "skill_loader.py"))
skill_executor_module = load_module_from_file("leo_subagents.skills_bridge.skill_executor", str(current_path / "leo_subagents" / "skills_bridge" / "skill_executor.py"))

SkillLoader = skill_loader.SkillLoader
SkillExecutor = skill_executor_module.SkillExecutor

# 创建task_agent模块的依赖
task_agent_module = load_module_from_file("leo_subagents.agents.task_agent", str(current_path / "leo_subagents" / "agents" / "task_agent.py"))
TaskAgent = task_agent_module.TaskAgent

# 加载新实现的3个Agent
try:
    research_agent_module = load_module_from_file("leo_subagents.agents.research_agent", str(current_path / "leo_subagents" / "agents" / "research_agent" / "research_agent.py"))
...
try:
    analysis_agent_module = load_module_from_file("leo_subagents.agents.analysis_agent", str(current_path / "leo_subagents" / "agents" / "analysis_agent" / "analysis_agent.py"))
...
try:
    creative_agent_module = load_module_from_file("leo_subagents.agents.creative_agent", str(current_path / "leo_subagents" / "agents" / "creative_agent" / "creative_agent.py"))
...
try:
    realestate_agent_module = load_module_from_file("leo_subagents.agents.realestate_agent", str(current_path / "leo_subagents" / "agents" / "realestate_agent" / "realestate_agent.py"))
