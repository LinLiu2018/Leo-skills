    ...
    "levels": [
        {
            ...
            "modules": [
                {
                    "name": "什么是 AI",
                    "topics": ["AI 是什么", "AI 能做什么", "AI 在哪里"],
                    "activities": ["AI 应用体验", "AI 小游戏"],
                    "outcome": "了解 AI 基本概念"
                },
                {
                    "name": "AI 好朋友",
                    "topics": ["语音助手", "智能推荐", "图像识别"],
                    "activities": ["和 Siri 对话", "体验人脸识别"],
                    "outcome": "认识常见的 AI 应用"
                },
                {
                    "name": "AI 小创客",
                    "topics": ["简单编程", "图形化编程", "AI 绘画"],
                    "activities": ["Scratch 编程", "AI 画画体验"],
                    "outcome": "初步体验 AI 创作"
                }
            ],
            "resources": [
                {"type": "视频", "name": "AI 是什么", "url": "待添加"},
                {"type": "游戏", "name": "AI 体验小游戏", "url": "待添加"},
                {"type": "绘本", "name": "AI 启蒙绘本", "url": "待添加"}
            ],
            ...
            "modules": [
                {
                    ...
                    "activities": ["编写小程序", "数据处理练习"],
                    "outcome": "掌握 Python 基础"
                },
                {
                    "name": "机器学习入门",
                    "topics": ["什么是机器学习", "监督学习", "分类与回归"],
                    "activities": ["训练简单模型", "数据可视化"],
                    "outcome": "理解机器学习原理"
                },
                {
                    "name": "AI 项目实战",
                    "topics": ["情感分析", "图像分类", "智能对话"],
                    "activities": ["制作聊天机器人", "图片识别项目"],
                    "outcome": "完成 2-3 个 AI 项目"
                }
            ],
            "resources": [
                {"type": "教程", "name": "Python 入门教程", "url": "待添加"},
                {"type": "课程", "name": "机器学习入门", "url": "待添加"},
                {"type": "项目", "name": "AI 实战项目集", "url": "待添加"}
            ],
        ...
        },
        {
            ...
            "modules": [
                {
                    "name": "深度学习基础",
                    "topics": ["神经网络", "反向传播", "优化算法"],
                    "activities": ["搭建神经网络", "调参实验"],
                    "outcome": "掌握深度学习原理"
                },
                {
                    "name": "计算机视觉",
                    "topics": ["CNN", "目标检测", "图像分割"],
                    "activities": ["图像分类项目", "目标检测实战"],
                    "outcome": "掌握 CV 核心技术"
                },
                {
                    "name": "自然语言处理",
                    "topics": ["RNN", "Transformer", "语言模型"],
                    "activities": ["文本分类", "情感分析项目"],
                    "outcome": "掌握 NLP 核心技术"
                },
                {
                    "name": "AI 工程化",
                    "topics": ["模型部署", "API 开发", "性能优化"],
                    "activities": ["部署模型到云端", "开发 AI 应用"],
                    "outcome": "具备工程落地能力"
                }
            ],
            "resources": [
                {"type": "课程", "name": "深度学习专项课程", "url": "待添加"},
                {"type": "书籍", "name": "深度学习花书", "url": "待添加"},
                {"type": "框架", "name": "PyTorch/TensorFlow", "url": "待添加"}
            ],
        ...
        },
        {
            ...
            "modules": [
                {
                    "name": "大模型技术",
                    "topics": ["LLM 架构", "Prompt Engineering", "RAG"],
                    "activities": ["微调大模型", "构建 AI 应用"],
                    "outcome": "掌握大模型技术栈"
                },
                {
                    "name": "AI 系统架构",
                    "topics": ["分布式训练", "模型压缩", "推理优化"],
                    "activities": ["大规模训练实验", "模型优化实战"],
                    "outcome": "具备系统设计能力"
                },
                {
                    "name": "AI 伦理与安全",
                    "topics": ["AI 伦理", "模型安全", "隐私保护"],
                    "activities": ["伦理案例分析", "安全审计实践"],
                    "outcome": "具备 AI 伦理意识"
                },
                {
                    "name": "研究能力培养",
                    "topics": ["论文阅读", "实验设计", "学术写作"],
                    "activities": ["复现顶会论文", "撰写技术博客"],
                    "outcome": "具备独立研究能力"
                }
            ],
            "resources": [
                {"type": "论文", "name": "顶会论文精选", "url": "待添加"},
                {"type": "开源", "name": "GitHub 优质项目", "url": "待添加"},
                {"type": "社区", "name": "AI 技术社区", "url": "待添加"}
            ],
            "assessment": "完成 1 个研究项目和 2 篇技术文章"
        }
    ],
    "learning_path": {
        "total_duration": "39-60 个月",
        "prerequisites": "无（小学级从零开始）",
        "certificate": "每级完成后获得相应证书",
        "career_paths": [
            "AI 工程师",
            "机器学习工程师",
            "数据科学家",
    ...
    <div class="container">
        <div class="levels">
            <div class="level-card">
                ...
                <a href="elementary.html" style="display:block; margin-top:1rem; color:#667eea; text-decoration:none;">查看详情 →</a>
            </div>
            <div class="level-card">
                <h2>🎓 初中级</h2>
                ...
                <a href="intermediate.html" style="display:block; margin-top:1rem; color:#667eea; text-decoration:none;">查看详情 →</a>
            </div>
            <div class="level-card">
                <h2>🎓 高中级</h2>
                ...
                <a href="advanced.html" style="display:block; margin-top:1rem; color:#667eea; text-decoration:none;">查看详情 →</a>
            </div>
            <div class="level-card">
                <h2>🎓 大学级</h2>
                ...
                <a href="professional.html" style="display:block; margin-top:1rem; color:#667eea; text-decoration:none;">查看详情 →</a>
            </div>
        </div>
        <div class="path">
            <h2>📍 学习路径</h2>
...
def generate_level_page(level_data):
    """生成等级页面"""
    name = level_data["name"]
    filename = name.replace("级", "") + ".html"
    
    modules_html = ""
    for i, module in enumerate(level_data["modules"], 1):
        modules_html += f"""
        <div class="module">
            <h3>{i}. {module["name"]}</h3>
    ...
    resources_html = ""
    for res in level_data["resources"]:
...
<body>
    ...
    <div class="container">
        <div class="info">
            <p><strong>📅 时长:</strong> {level_data["duration"]}</p>
            <p><strong>👥 目标:</strong> {level_data["target"]}</p>
            <p><strong>📖 描述:</strong> {level_data["description"]}</p>
            <p><strong>✅ 考核:</strong> {level_data["assessment"]}</p>
        </div>
...
# 生成网站
print("=" * 60)
print("AI 学习网站生成器 - 四级进阶体系")
print("=" * 60)

# 生成首页
with open(OUTPUT_DIR / "index.html", "w", encoding="utf-8") as f:
    f.write(generate_index())
print(f"[OK] 生成首页：index.html")
