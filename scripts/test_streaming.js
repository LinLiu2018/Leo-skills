/**
 * 流式输出测试脚本
 * 运行方式: cd D:\moltbot && node d:\桌面\leo_ai_system\scripts\test_streaming.js
 */
const fs = require("fs");
const path = require("path");

// 加载 streaming.js
const streamingPath = "D:\\moltbot\\extensions\\feishu\\dist\\src\\streaming.js";
const streaming = require(streamingPath);
...
测试时间: ${new Date().toLocaleString("zh-CN")}`;
  ...
  try {
    console.log("📤 发送流式消息中...");
    await streaming.sendStreamingText({
      cfg: config,
