...
class EmailAutomationSkill:
    """
    email_automation_skill 技能实现
    """

    def __init__(self):
        self.name = "email_automation_skill"
        self.version = "1.0.0"
...
def get_skill() -> EmailAutomationSkill:
    """获取技能实例"""
    global _skill_instance
    if _skill_instance is None:
        _skill_instance = EmailAutomationSkill()
