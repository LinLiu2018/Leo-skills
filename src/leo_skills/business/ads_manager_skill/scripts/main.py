...
class AdsManagerSkill:
    """
    ads_manager_skill 技能实现
    """

    def __init__(self):
        self.name = "ads_manager_skill"
        self.version = "1.0.0"
...
def get_skill() -> AdsManagerSkill:
    """获取技能实例"""
    global _skill_instance
    if _skill_instance is None:
        _skill_instance = AdsManagerSkill()
