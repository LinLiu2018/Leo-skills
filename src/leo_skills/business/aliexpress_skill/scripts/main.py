...
class AliexpressSkill:
    """
    aliexpress_skill 技能实现
    """

    def __init__(self):
        self.name = "aliexpress_skill"
        self.version = "1.0.0"
...
def get_skill() -> AliexpressSkill:
    """获取技能实例"""
    global _skill_instance
    if _skill_instance is None:
        _skill_instance = AliexpressSkill()
