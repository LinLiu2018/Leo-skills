# -*- coding: utf-8 -*-
"""
competitor_content_crawler_skill - 生产级实现
"""
...
class CompetitorContentCrawlerSkill:
    """
    competitor_content_crawler_skill 技能实现
    """

    def __init__(self):
        self.name = "competitor_content_crawler_skill"
        self.version = "1.0.0"
...
def get_skill() -> CompetitorContentCrawlerSkill:
    """获取技能实例"""
    global _skill_instance
    if _skill_instance is None:
        _skill_instance = CompetitorContentCrawlerSkill()
