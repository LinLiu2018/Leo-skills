...
class ComplianceCheckSkill:
    """
    compliance_check_skill 技能实现
    """

    def __init__(self):
        self.name = "compliance_check_skill"
        self.version = "1.0.0"
...
def get_skill() -> ComplianceCheckSkill:
    """获取技能实例"""
    global _skill_instance
    if _skill_instance is None:
        _skill_instance = ComplianceCheckSkill()
