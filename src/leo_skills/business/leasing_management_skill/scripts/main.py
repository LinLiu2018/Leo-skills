# -*- coding: utf-8 -*-
"""
leasing_management_skill - 生产级实现
"""
...
class LeasingManagementSkill:
    """
    leasing_management_skill 技能实现
    """

    def __init__(self):
        self.name = "leasing_management_skill"
        self.version = "1.0.0"
...
def get_skill() -> LeasingManagementSkill:
    """获取技能实例"""
    global _skill_instance
    if _skill_instance is None:
        _skill_instance = LeasingManagementSkill()
