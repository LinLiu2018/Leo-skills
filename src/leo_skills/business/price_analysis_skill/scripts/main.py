...
class PriceAnalysisSkill:
    """
    price_analysis_skill 技能实现
    """

    def __init__(self):
        self.name = "price_analysis_skill"
        self.version = "1.0.0"
...
def get_skill() -> PriceAnalysisSkill:
    """获取技能实例"""
    global _skill_instance
    if _skill_instance is None:
        _skill_instance = PriceAnalysisSkill()
