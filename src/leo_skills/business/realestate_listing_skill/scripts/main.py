# -*- coding: utf-8 -*-
"""
realestate_listing_skill - 生产级实现
"""
...
class RealestateListingSkill:
    """
    realestate_listing_skill 技能实现
    """

    def __init__(self):
        self.name = "realestate_listing_skill"
        self.version = "1.0.0"
...
def get_skill() -> RealestateListingSkill:
    """获取技能实例"""
    global _skill_instance
    if _skill_instance is None:
        _skill_instance = RealestateListingSkill()
