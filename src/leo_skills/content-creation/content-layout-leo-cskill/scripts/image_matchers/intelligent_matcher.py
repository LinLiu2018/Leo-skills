...
class ImageMatcher:
    ...
    def match_images_for_content(
        self, content: str, sections: List[Dict[str, Any]] = None
    ) -> List[Dict[str, Any]]:
        """
        为内容匹配图片
    ...
    def generate_image_prompts(
        ...
        for theme in themes:
            ...
            prompts.append(
                {"theme": theme, "prompt": prompt, "style": style, "aspect_ratio": "16:9"}
            )
...
class ImagePromptGenerator:
    ...
    def generate_for_section(
        ...
        prompt_config = section_prompts.get(
            section_type, self._default_prompt(keywords, style_name)
        )
