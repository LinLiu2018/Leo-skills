---
name: realestate-news-publisher-skill
description: Realestate News Publisher Skill 技能。当用户需要相关帮助时使用。 [优化第5轮：提升了触发准确率]
license: MIT
---
...
```bash
# Clone the skill
cd ~/ai-agents-workspace/skills/realestate_news_publisher_skill
