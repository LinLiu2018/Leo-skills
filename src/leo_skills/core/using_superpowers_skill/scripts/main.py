...
class UsingSuperpowersSkill:
    """
    using_superpowers_skill 技能实现
    """

    def __init__(self):
        self.name = "using_superpowers_skill"
        self.version = "1.0.0"
        self.category = "core"
...
def get_skill() -> UsingSuperpowersSkill:
    """获取技能实例"""
    global _skill_instance
    if _skill_instance is None:
        _skill_instance = UsingSuperpowersSkill()
