# -*- coding: utf-8 -*-
"""
finishing_development_branch_skill - 生产级实现
"""
...
class FinishingDevelopmentBranchSkill:
    """
    finishing_development_branch_skill 技能实现
    """
...
def get_skill() -> FinishingDevelopmentBranchSkill:
    """获取技能实例"""
    global _skill_instance
    if _skill_instance is None:
        _skill_instance = FinishingDevelopmentBranchSkill()
