...
class WeuiMiniprogramSkill:
    """
    weui_miniprogram_skill 技能实现
    """

    def __init__(self):
        self.name = "weui_miniprogram_skill"
        self.version = "1.0.0"
...
def get_skill() -> WeuiMiniprogramSkill:
    """获取技能实例"""
    global _skill_instance
    if _skill_instance is None:
        _skill_instance = WeuiMiniprogramSkill()
