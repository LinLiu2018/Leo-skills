...
- ❌ 需要采集大量推文（受 API 配额限制）
- ❌ 需要分析推文内容（请使用 tech-extractor-cskill）
...
- **tech-extractor-cskill**: 从推文中提取 AI 技术信息
- **skill-code-generator-cskill**: 基于技术信息生成代码
- **obsidian-sync-cskill**: 同步到 Obsidian 知识库
