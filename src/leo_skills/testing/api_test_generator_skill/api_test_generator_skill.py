...
from .scripts.main import APITestGenerator as _LegacyAPITestGenerator


class APITestGenerator(BaseExecutor):
    """Executor wrapper for legacy APITestGenerator."""

    def __init__(self) -> None:
        self.name = "api_test_generator_skill"
        self._delegate = _LegacyAPITestGenerator()
