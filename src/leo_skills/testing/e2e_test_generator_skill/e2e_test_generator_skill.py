...
from .scripts.main import E2ETestGenerator as _LegacyE2ETestGenerator


class E2ETestGenerator(BaseExecutor):
    """Executor wrapper for legacy E2ETestGenerator."""

    def __init__(self) -> None:
        self.name = "e2e_test_generator_skill"
        self._delegate = _LegacyE2ETestGenerator()
