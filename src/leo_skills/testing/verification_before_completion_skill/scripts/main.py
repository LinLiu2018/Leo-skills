# -*- coding: utf-8 -*-
"""
verification_before_completion_skill - 生产级实现
"""
...
class VerificationBeforeCompletionSkill:
    """
    verification_before_completion_skill 技能实现
    """
...
def get_skill() -> VerificationBeforeCompletionSkill:
    """获取技能实例"""
    global _skill_instance
    if _skill_instance is None:
        _skill_instance = VerificationBeforeCompletionSkill()
