...
```bash
/plugin marketplace add ./agent_skill_creator_skill
```
...
Discovers: agent_skill_creator_skill-plugin
↓
...
```
agent_skill_creator_skill/                    ← MARKETPLACE
...
```
article_to_prototype_skill/            ← SEPARATE MARKETPLACE
...
Installation: /plugin marketplace add ./article_to_prototype_skill
```
...
├── data_analyzer_skill/SKILL.md     ← Component skill 1
...
├── agent_skill_creator_skill/               ← Main tool (marketplace)
│   ├── .claude-plugin/marketplace.json
│   ├── SKILL.md                       ← Meta-skill functionality
│   └── references/examples/
│       └── stock-analyzer-cskill/     ← Example created skill
│
├── article_to_prototype_skill/       ← Independent skill (separate marketplace)
│   ├── .claude-plugin/marketplace.json
...
```bash
/plugin marketplace add ./agent_skill_creator_skill
/plugin marketplace add ./article_to_prototype_skill
...
4. **article_to_prototype_skill is completely independent** from Agent Creator
...
/plugin marketplace add FrancyJGLisboa/agent_skill_creator_skill
```
...
```bash
/plugin list
# You should see: ✓ agent_skill_creator_skill
```
...
If you also want to use the `article_to_prototype_skill` (mentioned in the hierarchy section):
...
/plugin list
# Should show both: ✓ agent_skill_creator_skill AND ✓ article_to_prototype_skill
```
...
```bash
✓ Added agent-creator-enhanced from /path/to/agent_skill_creator_skill
...
pwd  # Should be in agent_skill_creator_skill directory
...
❌ /plugin marketplace add FrancyJGLisboa/agent_skill_creator_skill
✅ /plugin marketplace add FrancyJGLisboa/agent_skill_creator_skill
# Note: Repository name is agent_skill_creator_skill (not agent-creator)
```
...
**A:** Installation is simple: `/plugin marketplace add FrancyJGLisboa/agent_skill_creator_skill` in Claude Code, then create agents with natural language commands.
...
- **GitHub Discussions**: [github.com/FrancyJGLisboa/agent_skill_creator_skill/discussions](https://github.com/FrancyJGLisboa/agent_skill_creator_skill/discussions)
- **Issues & Support**: [github.com/FrancyJGLisboa/agent_skill_creator_skill/issues](https://github.com/FrancyJGLisboa/agent_skill_creator_skill/issues)
