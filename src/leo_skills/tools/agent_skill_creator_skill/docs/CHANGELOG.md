...
- **Smart Exclusions**: Automatic filtering of .git/, **pycache**/, .env, credentials
...
v3.2 makes agent_skill_creator_skill skills **truly universal**. Create once in Claude Code, export for everywhere:
