...
**Version:** 3.2
**Purpose:** Complete guide to exporting agent_skill_creator_skill skills for use across all Claude platforms

---

## 🎯 Overview

Skills created by agent_skill_creator_skill are optimized for **Claude Code**, but can be exported for use across all Claude platforms:
...
After creating a skill, agent_skill_creator_skill will prompt:
...
# Or via agent_skill_creator_skill
...
- GitHub Issues: [agent_skill_creator_skill issues](https://github.com/FrancyJGLisboa/agent_skill_creator_skill/issues)

---

**Generated by:** agent_skill_creator_skill v3.2
