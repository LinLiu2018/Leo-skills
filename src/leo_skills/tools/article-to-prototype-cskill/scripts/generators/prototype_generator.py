...
class PrototypeGenerator:
    ...
    def generate(
        ...
        if language == "python":
            ...
            entry_point, files = self._generate_javascript(
                analysis, output_dir, source_info, language
            )
        elif language == "rust":
    ...
    def _generate_python(
        self, analysis: Any, output_dir: str, source_info: Optional[Dict[str, Any]]
    ) -> tuple[str, List[str]]:
...
'''
    ...
    def _generate_javascript(
        self, analysis: Any, output_dir: str, source_info: Optional[Dict[str, Any]], language: str
    ) -> tuple[str, List[str]]:
    ...
    def _generate_js_main(
        self, analysis: Any, source_info: Optional[Dict[str, Any]], language: str
    ) -> str:
...
"""
    ...
    def _generate_readme(
        self, analysis: Any, language: str, output_dir: str, source_info: Optional[Dict[str, Any]]
    ) -> str:
        """Generate README.md"""
        source_url = source_info.get("source_url", "Unknown") if source_info else "Unknown"
        source_title = source_info.get("title", "Untitled") if source_info else "Untitled"
