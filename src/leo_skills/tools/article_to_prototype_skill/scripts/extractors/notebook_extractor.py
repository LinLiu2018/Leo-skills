...
class NotebookExtractor:
    ...
    def _process_markdown_cell(self, cell: Any, cell_num: int) -> Optional[Section]:
        ...
        if lines[0].startswith("#"):
            ...
            return Section(
                heading=heading, level=level, content=body, line_number=cell_num, subsections=[]
            )
    ...
    def _process_code_cell(self, cell: Any, cell_num: int) -> Optional[CodeBlock]:
        ...
        return CodeBlock(language=language, code=code, line_number=cell_num, context=context)
