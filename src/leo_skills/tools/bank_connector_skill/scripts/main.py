...
class BankConnectorSkill:
    """
    bank_connector_skill 技能实现
    """

    def __init__(self):
        self.name = "bank_connector_skill"
        self.version = "1.0.0"
        self.category = "tools"
...
def get_skill() -> BankConnectorSkill:
    """获取技能实例"""
    global _skill_instance
    if _skill_instance is None:
        _skill_instance = BankConnectorSkill()
