...
class CloudStorageSkill:
    """
    cloud_storage_skill 技能实现
    """

    def __init__(self):
        self.name = "cloud_storage_skill"
        self.version = "1.0.0"
        self.category = "tools"
...
def get_skill() -> CloudStorageSkill:
    """获取技能实例"""
    global _skill_instance
    if _skill_instance is None:
        _skill_instance = CloudStorageSkill()
