...
class ContentToActionSkill:
    """
    content_to_action_skill 技能实现
    """
...
def get_skill() -> ContentToActionSkill:
    """获取技能实例"""
    global _skill_instance
    if _skill_instance is None:
        _skill_instance = ContentToActionSkill()
