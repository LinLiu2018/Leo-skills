# -*- coding: utf-8 -*-
"""
interest_calculator_skill - 生产级实现
"""
...
class InterestCalculatorSkill:
    """
    interest_calculator_skill 技能实现
    """

    def __init__(self):
        self.name = "interest_calculator_skill"
        self.version = "1.0.0"
...
def get_skill() -> InterestCalculatorSkill:
    """获取技能实例"""
    global _skill_instance
    if _skill_instance is None:
        _skill_instance = InterestCalculatorSkill()
