# -*- coding: utf-8 -*-
"""
mortgage_calculator_skill - 生产级实现
"""
...
class MortgageCalculatorSkill:
    """
    mortgage_calculator_skill 技能实现
    """

    def __init__(self):
        self.name = "mortgage_calculator_skill"
        self.version = "1.0.0"
...
def get_skill() -> MortgageCalculatorSkill:
    """获取技能实例"""
    global _skill_instance
    if _skill_instance is None:
        _skill_instance = MortgageCalculatorSkill()
