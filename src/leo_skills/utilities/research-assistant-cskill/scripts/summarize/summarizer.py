...
class Summarizer:
    ...
    def summarize(self, paper: "Paper", max_length: int = 200, style: str = "concise") -> str:
        """
    ...
    def _score_sentence(
        self, sentence: str, position: int, total: int, keywords: List[str]
    ) -> float:
        """
        ...
        # Feature indicators
        if re.search(
            r"(?i)(we (find|show|demonstrate)|results? (show|suggest)|conclusion)", sentence
        ):
            score += 0.5
    ...
    def _extract_key_sentences(self, text: str, max_words: int, paper: "Paper") -> List[str]:
    ...
    def _generate_concise_summary(self, text: str, paper: "Paper", max_words: int = 200) -> str:
    ...
    def _generate_detailed_summary(self, text: str, paper: "Paper", max_words: int = 500) -> str:
        """Generate a detailed summary."""
        alloc = self._allocate_words(paper, max_words)

        self._extract_key_sentences(text, alloc["content"], paper)
    ...
    def _generate_bullet_summary(self, text: str, paper: "Paper", max_words: int = 200) -> str:
        ...
        if hasattr(paper, "citation_count") and paper.citation_count:
            summary_parts.append(f"[DATA] **Citations:** {paper.citation_count}\n")
    ...
    def _generate_abstract_style(self, text: str, paper: "Paper", max_words: int = 250) -> str:
    ...
    def _generate_findings_summary(self, paper: "Paper", max_words: int = 200) -> str:
    ...
    def _allocate_words(self, paper: "Paper", max_words: int) -> Dict[str, int]:
    ...
    def generate_comparative_summary(
        self, papers: List["Paper"], focus: str = "methodology"
    ) -> str:
        """
        ...
        summary_parts = [f"# Comparative Analysis: {len(papers)} Papers\n\n"]
