...
class CitationManager:
    ...
    def format_citation(self, paper: "Paper", style: str = "apa") -> str:
        """
    ...
    def format_multiple(self, papers: List["Paper"], style: str = "apa") -> List[str]:
        """
    ...
    def generate_bibliography(
        self, papers: List["Paper"], style: str = "apa", title: str = "Bibliography"
    ) -> str:
        """
    ...
    def generate_bibliography_bibtex(
        self, papers: List["Paper"], title: str = "Bibliography"
    ) -> str:
        """
    ...
    def extract_citations_from_text(
        ...
        for match in matches:
            citations.append({"raw": match, "parsed": self._parse_citation(match, style)})

        return citations

    def _parse_citation(self, citation: str, style: str) -> Dict[str, str]:
    ...
    def convert_citation_style(
        self, citation: str, from_style: str, to_style: str, paper: "Paper"
    ) -> str:
        """
