# -*- coding: utf-8 -*-
"""
youtube_summarizer_skill - 生产级实现
"""
...
class YoutubeSummarizerSkill:
    """
    youtube_summarizer_skill 技能实现
    """

    def __init__(self):
        self.name = "youtube_summarizer_skill"
        self.version = "1.0.0"
...
def get_skill() -> YoutubeSummarizerSkill:
    """获取技能实例"""
    global _skill_instance
    if _skill_instance is None:
        _skill_instance = YoutubeSummarizerSkill()
