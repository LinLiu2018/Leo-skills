...
| `videocut:cut_speech` | 转录 + 口误/静音识别 → 审查稿 | 剪口播、处理视频 |
| `videocut:video_editing` | 执行 FFmpeg 剪辑 + 循环审查 | 执行剪辑、确认 |
| `videocut:subtitle` | 字幕生成与烧录 | 加字幕、生成字幕 |
| `videocut:auto_update` | 从错误中学习，更新规则 | 更新规则、记录反馈 |
