...
class TestSystemBasics:
    ...
    def test_project_structure_exists(self):
        ...
        assert (src_path / "leo_skills").exists()
        assert (src_path / "leo_subagents").exists()
        assert (src_path / "leo_orchestrator").exists()
        assert (src_path / "leo_workflows").exists()
        assert (src_path / "leo_knowledge").exists()
...
class TestEncodingFixes:
    ...
    def test_files_use_utf8_encoding(self):
        ...
        key_files = [
            ...
            "src/leo_knowledge/context/user_profile.md",
        ]
